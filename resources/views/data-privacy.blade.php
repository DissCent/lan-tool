...
<div>
    <div class="bg-white dark:dark:bg-gray-800/50 shadow-sm overflow-hidden max-w-xs sm:max-w-lg md:max-w-2xl w-screen sm:rounded-lg mb-4 dark:outline-white/10 dark:outline-1 dark:-outline-offset-1">
        <div class="px-4 py-5 sm:px-6">
            <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" x-show="open">
                <h1 class="text-center text-3xl font-extrabold text-gray-900 dark:text-white dark:text-black w-auto mb-4">Datenschutzhinweise</h1>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-black w-auto my-3">Verantwortlicher</h2>
                ...
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-black w-auto my-3">Ihre Betroffenenrechte</h2>
                ...
                <p class="mb-4"></p>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-black w-auto my-3">Verarbeitungstätigkeiten</h2>
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Erfassung allgemeiner Informationen beim Besuch unserer Website</h3>
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Art und Zweck der Verarbeitung</h4>
                ...
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Rechtsgrundlage und berechtigtes Interesse</h4>
                ...
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Empfänger</h4>
                ...
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Speicherdauer</h4>
                ...
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Bereitstellung vorgeschrieben oder erforderlich</h4>
                ...
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Widerspruch</h4>
                <p class="mb-4">Lesen Sie dazu die Informationen über Ihr Widerspruchsrecht nach Art. 21 DSGVO weiter unten.</p>
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Kontaktaufnahme</h3>
                ...
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Rechtsgrundlage</h4>
                ...
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Widerspruch</h4>
                <p class="mb-4">Lesen Sie dazu die Informationen über Ihr Widerspruchsrecht nach Art. 21 DSGVO weiter unten.</p>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-black w-auto my-3">Cookies</h2>
                ...
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Löschen von Cookies</h3>
                ...
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Technisch notwendige Cookies</h3>
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Art und Zweck der Verarbeitung</h4>
                ...
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Widerspruch</h4>
                <p class="mb-4">Lesen Sie dazu die Informationen über Ihr Widerspruchsrecht nach Art. 21 DSGVO weiter unten.</p>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-black w-auto my-3">Information über Ihr Widerspruchsrecht nach Art. 21 DSGVO</h2>
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Einzelfallbezogenes Widerspruchsrecht</h3>
                ...
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Empfänger eines Widerspruchs</h3>
                <p class="mb-4">
                    <span class="personal">{{ str_rot13(strrev(base64_decode('em5lcm9MIHBwaWxpaFAK'))) }}</span>
                    <br />
                    <span class="personal">{{ str_rot13(strrev(base64_decode('NDIgLnJ0UyByZXJhbWllVwo' . '='))) }}</span>
                ...
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-black w-auto my-3">Änderung unserer Datenschutzerklärung</h2>
                ...
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-black w-auto my-3">Fragen zum Datenschutz</h2>
                ...
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-black w-auto my-3">Urheberrechtliche Hinweise</h2>
...
<div>
    <div class="bg-white shadow-sm overflow-hidden max-w-xs sm:max-w-lg md:max-w-2xl w-screen sm:rounded-lg mb-4">
        <div class="px-4 py-5 sm:px-6">
            <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" x-show="open">
                <h1 class="text-center text-3xl font-extrabold text-gray-900 dark:text-white dark:text-black w-auto mb-4">Privacy Notice</h1>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-black w-auto my-3">Controller</h2>
                ...
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-black w-auto my-3">Your Rights as a Data Subject</h2>
                ...
                <p class="mb-4">A list of supervisory authorities (for the non-public sector) with addresses can be found at: <a
                        ...
                        rel="noopener nofollow" class="underline">https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_links-node.html</a>.</p>
                <p class="mb-4"></p>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-black w-auto my-3">Processing Activities</h2>
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Collection of General Information When Visiting Our Website</h3>
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Type and Purpose of Processing</h4>
                ...
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Legal Basis and Legitimate Interest</h4>
                ...
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Recipients</h4>
                ...
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Storage Duration</h4>
                ...
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Provision Required or Necessary</h4>
                ...
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Objection</h4>
                <p class="mb-4">Please refer to the information on your right to object under Art. 21 GDPR further below.</p>
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Contacting Us</h3>
                ...
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Legal Basis</h4>
                ...
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Deleting Cookies</h3>
                ...
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Technically Necessary Cookies</h3>
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Type and Purpose of Processing</h4>
                ...
                <h4 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Objection</h4>
                <p class="mb-4">Please refer to the information on your right to object under Art. 21 GDPR further below.</p>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-black w-auto my-3">Information About Your Right to Object Under Art. 21 GDPR</h2>
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Right to Object on a Case-by-Case Basis</h3>
                ...
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white dark:text-black w-auto my-3">Recipient of an Objection</h3>
                <p class="mb-4">
                    <span class="personal">{{ str_rot13(strrev(base64_decode('em5lcm9MIHBwaWxpaFAK'))) }}</span>
                    <br />
                    <span class="personal">{{ str_rot13(strrev(base64_decode('NDIgLnJ0UyByZXJhbWllVwo' . '='))) }}</span>
                ...
                <hr>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-black w-auto my-3">Changes to our privacy policy</h2>
