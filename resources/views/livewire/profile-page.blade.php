        ...
        <form class="mt-8 space-y-6" action="#" method="POST" wire:submit="updateProfile">
            ...
            <div class="mt-4 space-y-4">
                <div class="flex items-start">
                    <div class="flex gap-3">
                        ...
                        <div class="text-sm/6">
                            <label for="show_zip_registered" class="font-medium text-gray-900 dark:text-white cursor-pointer">{{ __('profile-page.show-zip-registered') }}</label>
                        </div>
                    </div>
                </div>
                <div class="flex items-start">
                    <div class="flex gap-3">
                        ...
                        <div class="text-sm/6">
                            <label for="show_zip_public" class="font-medium text-gray-900 dark:text-white cursor-pointer">{{ __('profile-page.show-zip-public') }}</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <button type="button" x-show="success"
                    class="group relative w-full flex justify-center items-center rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-green-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600 dark:bg-green-800 dark:shadow-none dark:hover:bg-green-700 dark:focus-visible:outline-green-800 mx-auto cursor-pointer">
                    <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                        <svg class="h-5 w-5 text-green-500 group-hover:text-green-400 dark:text-green-600 dark:group-hover:text-green-500"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                            aria-hidden="true">
                            <path fill-rule="evenodd"
                                d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z"
