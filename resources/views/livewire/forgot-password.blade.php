        ...
        <div class="rounded-md shadow-xs -space-y-px">
            ...
            <div>
                <input id="email" name="email" type="text" required wire:model.live="email"
                    class="appearance-none bg-white rounded-md relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-hidden focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
